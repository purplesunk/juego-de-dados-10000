...
void modoUnJugador(int mejorPuntaje[], char *nombreMejorPuntaje) {
    ...
    while (ronda < 10 && puntajeTotal != 10000) {
        ...
        puntajeTotal = validarPuntaje (puntajeObtenido, 
                                       puntajeTotal, 
                                       ronda, 
                                       nroLanzamiento, 
                                       rondaPuntajeObtenido, 
                                       lanzamientoPuntajeObtenido);
    }

    mostrarPuntajeFinal(nombreJugador, 
                        puntajeTotal, 
                        rondaPuntajeObtenido, 
                        lanzamientoPuntajeObtenido, 
                        " PUNTAJE OBTENIDO POR ");
    compararMejorPuntaje(nombreMejorPuntaje, 
                         mejorPuntaje, 
                         nombreJugador, 
                         puntajeTotal, 
                         rondaPuntajeObtenido, 
...
void modoDosJugadores(int mejorPuntaje[], char *nombreMejorPuntaje) {
    ...
    while (ronda < 10 && puntajeJugador1 != 10000 && puntajeJugador2 != 10000) {
        ...
        puntajeJugador1 = validarPuntaje(puntajeObtenido, 
                                         puntajeJugador1, 
                                         ronda, 
                                         nroLanzamiento, 
                                         rondaJugador1, 
        ...
        puntajeJugador2 = validarPuntaje(puntajeObtenido, 
                                         puntajeJugador2, 
                                         ronda, 
                                         nroLanzamiento, 
                                         rondaJugador2, 
    ...
    compararMejorPuntaje(nombreCompletoJugador1, 
                         vecJugador1, 
                         nombreCompletoJugador2, 
                         puntajeJugador2, 
                         rondaJugador2, 
                         lanzamientoJugador2);
    mostrarPuntajeFinal(nombreCompletoJugador1, 
                        vecJugador1[0], 
                        vecJugador1[1], 
                        vecJugador1[2], 
                        " GANA LA PARTIDA: ");
